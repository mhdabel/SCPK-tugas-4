...
% Last Modified by GUIDE v2.5 06-Mar-2020 23:25:15
...
input3 = get(handles.edit5,'string');
...
hasil1 = num2str(volume);
hasil2 = num2str(luas);

set(handles.text4,'string',(hasil1));
set(handles.text9,'string',(hasil2));
